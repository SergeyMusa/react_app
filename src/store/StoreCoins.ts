...
class StoreCoins {
  ...
  @observable public coinsLoadDisable: boolean = false;
  // state = {
  //   URL_COINS: `https://min-api.cryptocompare.com/data/top/mktcapfull?limit=${this.coinsCount}&tsym=USD&api_key={be8e1361d9e8e83cbdd0723b8e3792826ef753bbf8f8813ed8cf5d34dae7d07e}`
  // };
  // @observable public URL_COINSS: string = this.state.URL_COINS;
...
//  https://min-api.cryptocompare.com/data/top/mktcapfull?limit=50&tsym=USD&api_key={be8e1361d9e8e83cbdd0723b8e3792826ef753bbf8f8813ed8cf5d34dae7d07e}`
  ...
  setCoinsCount = (loadCount: string) => {
    if (+this.coinsCount < this.maxDownloadNumber) {
      ...
      console.log('URL_COINSS',URL_COINSS);
      this.loadData().then();
      // this._isBusy.isOpen;
